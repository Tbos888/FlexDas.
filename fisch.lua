print"✅ Security verification passed. Loading FlexDas..."
...
local Success, Error = pcall(function()
	...
	local Toasts = loadstring(
		game:HttpGet"https://you.whimper.xyz/sources/FlexDas/toast.lua"	
)()
...
-- ####################### ---
	...
	ThemeManager:SetFolder'FlexDas'
	SaveManager:SetFolder'FlexDas/Arise'
